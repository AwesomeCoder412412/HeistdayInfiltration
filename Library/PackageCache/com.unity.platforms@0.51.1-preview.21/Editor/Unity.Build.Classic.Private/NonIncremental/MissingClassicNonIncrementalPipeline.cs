...
namespace Unity.Build.Classic.Private
{
    ...
    /// </summary>
    sealed class MissingClassicNonIncrementalPipeline : ClassicNonIncrementalPipelineBase
    {
        ...
        public MissingClassicNonIncrementalPipeline(Platform platform)
        {
            Platform = platform;
        }
        ...
        static BuildStepCollection s_CachedPostProcessCollection;
        static BuildContext s_CachedContext;
        ...
        /// <returns></returns>
        BuildResult OnBuildSplit(BuildContext context)
        {
